...
\lstset{caption={Simplified runner.js}}
...
\lstset{caption={Go unit testing}}
\begin{lstlisting}[language={Go}]
...
\lstset{caption={JavaScript unit testing}}
\begin{lstlisting}[language={JavaScript}]
	jest.mock(k8sClient, () => ({
...
\lstset{caption={E2E testing of operator}}
\begin{lstlisting}[language={Go}]
